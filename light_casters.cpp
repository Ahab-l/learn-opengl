...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("shaders/lightcaster.vs", "shaders/lightcaster.fs");
    ...
    stbi_set_flip_vertically_on_load(true);
    data = stbi_load("texture/lighting_maps_specular_color.png", &width, &height, &nrChannels, 0);
    ...
    stbi_set_flip_vertically_on_load(true);
    data = stbi_load("texture/emission.jpg", &width, &height, &nrChannels, 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //float lightX = 3 * cos(glfwGetTime()); float lightZ = 3 * sin(glfwGetTime());
        //std::cout << lightX << " " << lightZ << std::endl;
        //lightPos.x = lightX;    lightPos.z = lightZ;    lightPos.y = 0;
