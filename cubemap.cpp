...
int main()
{
    ...
    // load models
    // -----------
    Model ourModel("texture/nanosuit_reflection/nanosuit.obj");
    ...
    for (int i = 0; i < 4; i++) {
        ...
        ourShader.setVec3("pointLights[" + std::to_string(i) + "].ambient", 0.2f, 0.2f, 0.2f);
        ourShader.setVec3("pointLights[" + std::to_string(i) + "].diffuse", 0.5f, 0.5f, 0.5f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.use();
        for (int i = 0; i < 4; i++) {
            ourShader.setVec3("pointLights[" + std::to_string(i) + "].position", pointLightPositions[i] * cos(currentFrame));
        }

        ourShader.setVec3("dirLight.direction", glm::vec3(sin(currentFrame), 0.0f, cos(currentFrame)));
        ...
        for (int j = 0; j < 4; j++) {
            ...
            model = glm::mat4(1.0f);
            model = glm::translate(model, pointLightPositions[j] * cos(currentFrame));
