...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/parallax/5.3.parallax_mapping.vs", "shaders/parallax/5.3.parallax_mapping.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("texture/toy_box_diffuse.png");
    unsigned int normalMap = loadTexture("texture/toy_box_normal.png");
    unsigned int heightMap = loadTexture("texture/toy_box_disp.png");
