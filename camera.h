...
glm::mat4 lookat(glm::vec3 Position, glm::vec3 target,glm::vec3 Up){
    ...
    glm::vec3 head = glm::normalize(glm::cross(front, right));
    rotate[0] = glm::vec4(right, 0.0f);
    rotate[1] = glm::vec4(head, 0.0f);
    rotate[2] = glm::vec4(front, 0.0f);
...
public:
    ...
    {
        glm::mat4 tes=lookat(Position, Position + Front, Up);
        glm::mat4 tes1=glm::lookAt(Position, Position + Front, Up);
